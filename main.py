...
def page3():
    ...
    with st.expander("🔥 优质作品：（高燃）埼玉训练1000天挑战终局之战，第1000天", expanded=True):
        col_vid1, col_desc1 = st.columns([3, 2])
        with col_vid1:
            st.video('https://www.bilibili.com/video/BV1Vjgzz3EgU/?spm_id_from=333.1387.homepage.video_card.click&vd_source=94c97a9b6d70d8f2128d2c95d83f5ec2')
        with col_desc1:
            st.markdown("""
            <div class="card" style="height: 100%;">
                <h4>视频信息</h4>
    ...
    st.link_button(
        '👉 访问本视频Bilibili链接', 
        'https://www.bilibili.com/video/BV1Vjgzz3EgU/?spm_id_from=333.1387.homepage.video_card.click',
        use_container_width=True,
        type="primary",
        help="点击跳转到B站链接看高清视频"
    )
